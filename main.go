...
import (
	...
	"github.com/k8s-tamias/tamias-ui/application"
...
func newConfig() (*viper.Viper, error) {
	...
	c := viper.New()
	c.SetDefault("dsn", fmt.Sprintf("postgres://%v@localhost:5432/tamias-ui?sslmode=disable", u.Username))
	c.SetDefault("cookie_secret", "7yo-4FAauTtRLZ2p")
